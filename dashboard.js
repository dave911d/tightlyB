...
var r = require('rethinkdb');//our database
var googleConfig = require('./oAuth/configGoogle.js');//Googles ouath configuration
var rethinkConfig = require('./rethinkConfig/configRethinkDb.js');//configures rethink
